...
import 'package:gamesroom/screens/home_screen1.dart';
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _registerUser(String Name, String email, String password) async {
    final url = 'https://nodejs-flutter-gamesroom-api.vercel.app/register'; // Replace with your API URL
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Wrap(
        children: [
          SizedBox(height: 10,),
          Center(child: Image.asset('assets/Images/auth-100.png',height: 100,)),
          Container(
  ...
  return Container(
    ...
    child: TextField(
      ...
      decoration: InputDecoration(
        ...
        contentPadding: EdgeInsets.fromLTRB(16, 0, 0, 0), // Add padding here
      ),
